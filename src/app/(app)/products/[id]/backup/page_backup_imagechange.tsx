                ...
                {Array.isArray(product.images) && product.images.length > 0 ? (
                  product.images.map((imgSrc, index) => (
                    <CarouselItem key={index}>
                      <div className="relative w-full h-[420px] bg-white flex items-center justify-center cursor-zoom-in">
                        <Image
                          src={imgSrc}
                  ...
                  <CarouselItem>
                    <div className="relative w-full h-[420px] bg-white flex items-center justify-center">
                      <Image
