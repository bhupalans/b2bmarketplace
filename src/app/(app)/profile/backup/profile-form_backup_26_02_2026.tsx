...
export function ProfileForm({ user }: ProfileFormProps) {
      ...
      useMemo(() => {
        return baseProfileSchema.superRefine((data, ctx) => {
            ...
            if (!data.shippingAddress) {
                ctx.addIssue({ code: z.ZodIssueCode.custom, message: "Shipping address is required.", path: ['shippingAddress'] });
            }
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Business Phone Number <span className="text-destructive">*</span></FormLabel>
                    <FormControl>
  ...
  <CardHeader>
    ...
    <CardDescription>
      Provide information that helps build trust with trading partners.
    </CardDescription>
  </CardHeader>
  <CardContent className="space-y-4">
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          ...
          <FormControl>
            <Textarea
              placeholder="Describe your company and what you trade."
              {...field}
              value={field.value || ''}
            />
          </FormControl>
    ...
    <FormField
      ...
      render={() => (
        <FormItem>
          <div className="mb-4">
            <FormLabel className="text-base">Business Scope <span className="text-destructive">*</span></FormLabel>
            <FormDescription>
              Select the markets your company operates in.
            </FormDescription>
          </div>
