...
if (offer.price?.baseAmount && offer.price?.baseCurrency) {
  unitPrice = offer.price.baseAmount;
  totalPrice = offer.price.baseAmount * offer.quantity;
  displayCurrency = offer.price.baseCurrency;
}


const formattedUnitPrice = new Intl.NumberFormat(undefined, {
  style: 'currency',
